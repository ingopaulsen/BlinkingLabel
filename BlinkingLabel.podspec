...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Ingo Paulsen/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ingo Paulsen' => 'i.paulsen@xsite.de' }
  s.source           = { :git => 'https://github.com/Ingo Paulsen/BlinkingLabel.git', :tag => s.version.to_s }
